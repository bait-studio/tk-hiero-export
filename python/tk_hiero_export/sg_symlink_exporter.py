...
from hiero.exporters import FnSymLinkExporter
from hiero.exporters import FnSymLinkExporterUI
...
class ShotgunSymLinkExporterUI(
    ShotgunHieroObjectBase, FnSymLinkExporterUI.SymLinkExporterUI
):
    """
    Custom Preferences UI for the shotgun symlink exporter.

    Embeds the UI for the std symlink UI.
    """
...
class ShotgunSymLinkExporter(
    ShotgunHieroObjectBase, FnSymLinkExporter.SymLinkExporter, CollatingExporter
):
    """
    Create SymLinkExporter object and send to Shotgun
    """

    def __init__(self, initDict):
        """Constructor"""
        FnSymLinkExporter.SymLinkExporter.__init__(self, initDict)
    ...
    def sequenceName(self):
        ...
        try:
            if self.isCollated():
                ...
                return FnSymLinkExporter.SymLinkExporter.sequenceName(self)
    ...
    def writeAudio(self):
        ...
        result = FnSymLinkExporter.SymLinkExporter.writeAudio(self)
    ...
    def startTask(self):
        ...
        return FnSymLinkExporter.SymLinkExporter.startTask(self)

    def finishTask(self):
        """Finish Task"""
        # run base class implementation
        FnSymLinkExporter.SymLinkExporter.finishTask(self)
        ...
        # Log usage metrics
        try:
            self.app.log_metric("SymLink & Publish", log_version=True)
        except:
            # ingore any errors. ex: metrics logging not supported
            pass


class ShotgunSymLinkPreset(
    ShotgunHieroObjectBase, FnSymLinkExporter.SymLinkPreset, CollatedShotPreset
):
    """Settings for the SG symlink step"""

    def __init__(self, name, properties):
        FnSymLinkExporter.SymLinkPreset.__init__(self, name, properties)
        self._parentType = ShotgunSymLinkExporter
