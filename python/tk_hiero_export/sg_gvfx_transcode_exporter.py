...
import hiero.ui # type: ignore
import hiero.core # type: ignore
from hiero.core import util # type: ignore
...
class GTranscodeExporterUI(
    ...
    def __init__(self, preset):
        ...
        self._displayName = "G|VFX Transcode"
        self._taskType = GTranscodeExporter
...
class GTranscodeExporter(
    ...
    def addWriteNodeToScript(self, script, rootNode, framerate):
        ...
        super(GTranscodeExporter, self).addWriteNodeToScript(
...
class GTranscodePreset(
    ...
    def __init__(self, name, properties):
        ...
        self._parentType = GTranscodeExporter
